...
```yaml
---
audience: [pm, architect, developer, tester, design, multi-agent]
...
Skip: ROADMAP (unless working on project planning)
```
...
- **Removed** Japanese-specific documentation
- **Updated** all references for dbt/data analytics focus
