...
- Ensure data models follow design patterns
...
| **SQL Style** | CTE naming, column formatting |
...
```
design: review the model structure for consistency
design: check if the mart design matches our patterns
design: audit the staging layer for completeness
design: verify the DAG structure is optimal
```
