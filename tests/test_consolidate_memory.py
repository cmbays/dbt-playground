...
class TestPatternGrouping:
    ...
    def test_group_similar_detects_patterns(self):
        ...
        items = [
            consolidate_memory.TextItem(today, "learning", "Always validate input before processing", "Task 1"),
            consolidate_memory.TextItem(today, "learning", "Validate input before you process it", "Task 2"),
    ...
    def test_score_pattern_recency_factor(self):
        ...
        recent_group = consolidate_memory.PatternGroup(
            ...
            items=[
                ...
                consolidate_memory.TextItem(today - timedelta(days=1), "learning", "Recent", "Task 2"),
            ],
        )
        ...
        old_group = consolidate_memory.PatternGroup(
            category="learning",
            items=[
                consolidate_memory.TextItem(today - timedelta(days=10), "learning", "Old", "Task 1"),
                consolidate_memory.TextItem(today - timedelta(days=12), "learning", "Old", "Task 2"),
            ],
        )
...
class TestMemoryIndexGeneration:
    ...
    def test_generate_memory_index_basic(self, memory_dir: Path):
        ...
        content = consolidate_memory.generate_memory_index(result, memory_dir)
...
class TestMemoryDirDetection:
    ...
    def test_get_memory_dir_not_found(self, tmp_path: Path, monkeypatch):
        ...
        with pytest.raises(FileNotFoundError, match="Not in a dbt-playground project"):
