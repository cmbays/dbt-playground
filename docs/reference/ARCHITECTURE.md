...
- [[PROJECT_STRUCTURE.md]] - Detailed file organization and naming conventions
- [[DESIGN_PRINCIPLES.md]] - UI/UX standards referenced in component architecture
- [[../CLAUDE.md]] - Project context and development workflow
- [[../.claude/rules/coding-style.md]] - Code standards for implementation
- [[../.claude/rules/security.md]] - Security guidelines for client-side data
